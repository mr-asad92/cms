<div class="container">
    <form action="<?php echo base_url();?>admin/updateInstallments" id="makeInstallmentForm" method="post" novalidate="novalidate">        <div class="panel panel-info">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="input-group date">
                                    <input value="<?php echo $to_date;?>" class="form-control " id="dto" name="FeeInstallment.ToDate" type="text">
...
<!--                            <button class="btn btn-primary pull-right" id="btnSubmit" type="submit"> Save </button>-->
                            <button class="btn btn-primary pull-right" id="makeInstallmentSubmit" type="button"> Save </button>
                        </div>
                        <div class="col-md-6">
