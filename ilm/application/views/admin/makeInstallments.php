<div class="container">
    <form action="<?php echo base_url();?>admin/saveInstallments" id="makeInstallmentForm" method="post" novalidate="novalidate">        <div class="panel panel-info">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-2">
                                ...
                                <input class="form-control txtCal valid" data-val="true" data-val-number="The field InitialAmount must be a number." id="InitialAmount" name="initialAmount" value="0" aria-describedby="InitialAmount-error" aria-invalid="false" type="text">
                            </div>
                            <div class="col-sm-2">
